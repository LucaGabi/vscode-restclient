...
export async function activate(context: ExtensionContext) {
    ...
    context.subscriptions.push(commands.registerCommand('gremlin-client.request', ((document: TextDocument, range: Range) => requestController.run(range))));
